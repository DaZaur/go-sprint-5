...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{TrainingType: r.Training.TrainingType,
		Duration: r.Duration,
		Distance: r.distance(),
		Speed:    r.meanSpeed(),
		Calories: r.Calories(),
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	squaredSpeed := math.Pow((w.meanSpeed() * KmHInMsec), 2) //средняя_скорость_в_метрах_в_секунду**2
	heightM := w.Height / CmInM                              //рост_в_метрах
	return (CaloriesWeightMultiplier*w.Weight + (squaredSpeed/heightM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{TrainingType: w.Training.TrainingType,
		Duration: w.Duration,
		Distance: w.distance(),
		Speed:    w.meanSpeed(),
		Calories: w.Calories(),
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{TrainingType: s.Training.TrainingType,
		Duration: s.Duration,
		Distance: s.distance(),
		Speed:    s.meanSpeed(),
		Calories: s.Calories(),
